...
const features = [
  {
    ...
    description:
      "Jeder Kämpfer hat unique Sprites für alle Aktionen: Stehen, Gehen, Angriff, Verteidigung, Sprung, Ducken, Sieg, Niederlage",
  },
  {
    icon: Zap,
    title: "SPEZIAL-ATTACKEN",
    description:
      "Donnernder Duft-Hammer, Sonic Stink-Welle, Turbo-Pups Combo und mehr epische Moves!",
    specialMoves: [
  ...
  },
  {
    ...
    description:
      "Der Furzsong, Der Furzsong2, Furz-Symphonie - Stage-spezifische Musik für maximale Stimmung",
  },
  {
    icon: MapPin,
    title: "6 KAMPF-ARENAS",
    description:
      "Kämpfe in einzigartigen Umgebungen mit animierten Hintergründen und Parallax-Effekten",
  },
  {
    icon: Smartphone,
    title: "MOBILE & DESKTOP SUPPORT",
    description:
      "Analog-Joystick für Mobile, Tastatur für Desktop, Haptic Feedback für Telegram Mini App",
  },
  {
    icon: Bot,
    title: "INTELLIGENTE KI",
    description:
      "Progressive Schwierigkeitsstufen, adaptive Gegner-Strategien und reaktive Kampf-Mechaniken",
  },
];
                ...
                {feature.specialMoves && (
                  <ul className="mt-4 space-y-2">
                    {feature.specialMoves.map((move, i) => (
                      <li
                        key={i}
                        className="flex items-center text-xs font-mono text-[#ff8c00]"
                      >
